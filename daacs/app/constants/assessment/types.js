import {SCORING_AVERAGE, SCORING_MANUAL, SCORING_LIGHTSIDE, SCORING_SUM} from 'daacs/constants/assessment/scoring-types';
...
export const TYPE_WRITING_PROMPT = {value: 'WRITING_PROMPT', label: 'Writing Prompt', scoringTypes: [SCORING_MANUAL, SCORING_LIGHTSIDE]};
